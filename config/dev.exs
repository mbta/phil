...
config :phil, PhilWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "YvmfDG9Miw8rzi5M2MriGLHzSpyb0ocmSoXFERZzzdmW21s4Iv+X1ubzOFPVAACo",
  watchers: [
...
config :phil, PhilWeb.Endpoint,
  ...
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phil_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :phil, dev_routes: true
